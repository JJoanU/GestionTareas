...
var persona = require('./src/ruta/PersonaRuta');
var contacto = require('./src/ruta/ContactoRuta');
var tarea = require('./src/ruta/TareaRura');
var subtarea = require('./src/ruta/SubtareaRuta');
var informe1 = require('./src/ruta/Informe1Ruta');
var informe2 = require('./src/ruta/Informe2Ruta');
var balance = require('./src/ruta/BalanceRuta');
var catalogo = require('./src/ruta/CatalogoRuta');
...
app.use('/tarea', tarea());
app.use('/subtarea', subtarea());
app.use('/informe1', informe1());
app.use('/informe2', informe2());
